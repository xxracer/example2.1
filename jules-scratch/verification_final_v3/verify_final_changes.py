...
def run(playwright):
    ...
    try:
        ...
        page.screenshot(path="jules-scratch/verification_final_v3/01_homepage_final.png")
        ...
        page.screenshot(path="jules-scratch/verification_final_v3/02_kids_page_verified.png")
        ...
        page.screenshot(path="jules-scratch/verification_final_v3/03_kids_program_scrolled.png")
