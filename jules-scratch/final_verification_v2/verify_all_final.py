...
def run(playwright):
    ...
    try:
        ...
        page.screenshot(path="jules-scratch/final_verification_v2/01_homepage_initial.png")
        ...
        page.screenshot(path="jules-scratch/final_verification_v2/02_kids_page_verified.png")
        ...
        page.screenshot(path="jules-scratch/final_verification_v2/03_kids_program_scrolled.png")
