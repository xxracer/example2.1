...
const KidsProgram = () => {
  ...
  return (
    <div className="program-page">
      ...
      <section className="program-hero" style={{ backgroundImage: "url('https://placehold.co/1920x1080?text=Kids+in+Uniforms')" }}>
      ...
      <section className="program-details-section">
        ...
        <div className="program-details-image">
          <img src="https://placehold.co/600x400?text=Instructor+Teaching+Kids" alt="Instructor teaching young kids" />
        </div>
      </section>

      <div style={{'textAlign':'center'}}>
        <img src="https://placehold.co/600x400?text=Smiling+Kids" alt="Smiling kids after class" />
      </div>
