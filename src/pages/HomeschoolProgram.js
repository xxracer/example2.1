...
const HomeschoolProgram = () => {
  ...
  return (
    <div className="program-page">
      ...
      <section className="program-hero" style={{ backgroundImage: "url('https://placehold.co/1920x1080?text=Homeschool+Class')" }}>
      ...
      <section className="program-details-section">
        ...
        <div className="program-details-image">
          <img src="https://placehold.co/600x400?text=Small+Homeschool+Class" alt="Small homeschool class" />
        </div>
      </section>

      <div style={{'textAlign':'center', 'marginBottom': '60px'}}>
        <img src="https://placehold.co/600x400?text=Parents+Watching" alt="Parents watching kids train" />
      </div>
